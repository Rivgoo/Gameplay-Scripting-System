using GSS.Kernel.Compiler.Exceptions;
    ...
    public sealed class Parser : IParser
    {
        ...
        private void EnsureRecursionLimit()
        {
            if (++_recursionDepth > MaxRecursionDepth)
            {
                ...
                throw new CompilationCanceledException("Parser recursion depth exceeded.");
            }
        }
        ...
        private ExpressionSyntax ParsePrimaryExpression()
        {
            switch (Current().Kind)
            {
                ...
                default:
                    ...
                    throw new ParseException($"Expected valid primary expression but found {badToken.Kind}.");
            }
        }
