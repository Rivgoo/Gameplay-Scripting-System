...
{
	public sealed class NullCoalescingExpressionSyntax : ExpressionSyntax
	{
		public ExpressionSyntax Left { get; }
		public SyntaxToken OperatorToken { get; }
		public ExpressionSyntax Right { get; }
		public override SyntaxKind Kind => SyntaxKind.NullCoalescingExpression;
		public override TextSpan Span => new TextSpan(Left.Span.Start, Right.Span.End - Left.Span.Start);

		public NullCoalescingExpressionSyntax(ExpressionSyntax left, SyntaxToken operatorToken, ExpressionSyntax right)
		{
			Left = left;
